  ...
  <header>
    <div class="nav d-flex justify-content-between align-items-center mt-2 mb-2">
      ...
      <div class="nav justify-content-end logined" v-if="loginChk">
        <div class="logined-info me-3 align-middle"><strong>{{loginUser.userName}}</strong> 님 안녕하세요.</div>
        <router-link to="/hospital"><button class="hospital-btn btn me-3" id="btn-hospital">Hospital</button></router-link>
            ...
            <b-dropdown
              ...
              text="Login">
                ...
                <div class="mb-3">
                  ...
                  <input type="password" class="form-control" id="userpwd" name="userpwd" placeholder="PW..." v-model="userPwd"/>
                </div>
              <div class="col-auto text-center">
                <button type="button" id="btn-login" class="btn btn-outline-primary mb-3" @click="chkVal">Login</button>
                <router-link to="/findpwd"><button type="button" id="btn-findpw" class="btn btn-primary mb-3">비밀번호 찾기</button></router-link>
              </div>
            </b-dropdown-form>
