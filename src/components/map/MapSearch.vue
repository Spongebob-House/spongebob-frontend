  ...
  <main>
    ...
    <section class="home-result-box">
      <div class="search-result">
        ...
        <div id="home-map" class="col-sm-12 p-0">
          <ka-kao-map :text="text"></ka-kao-map>
          <div class="col-sm-12 col-md-2" style="position: absolute; top: 3vh; left: 3vw; z-index: 2">
            <b-input-group size="sm" prepend="">
              <b-form-input
                ...
                @input="searchStart($event)"></b-form-input>

              <b-card
                style="position: absolute; margin-left: 0; z-index: 2; width: 100%; top: 3vh"
                v-if="searchList.length && text.length != 0">
                <li
                  class="mb-2 px-2"
                  :class="{ 'is-active': index === arrownum }"
                  v-for="(result, index) in searchList"
                  :dongCode="result.dongCode"
                  :key="index"
                  v-text="result.name"
                  @click="onClickEvent(index)"></li>
              </b-card>
            </b-input-group>
          </div>
          <div class="col-sm-12 col-md-4" style="position: absolute; top: 3vh; left: 20vw; z-index: 2">
            <span @click="onAvatarClick('MT1')">
              <b-avatar icon="cart4" badge-variant="success" variant="secondary">
                <template #badge v-if="isCategories.MT1"
            ...
            <span @click="onAvatarClick('CS2')">
              <b-avatar icon="shop" badge-variant="success" variant="primary">
                <template #badge v-if="isCategories.CS2"
                  ><b-icon icon="check" scale="2" variant="white"></b-icon
                ></template>
              </b-avatar>
            </span>
            ...
            <span @click="onAvatarClick('SC4')">
              <b-avatar badge-variant="success" variant="dark">
                ...
                <template #badge v-if="isCategories.SC4"
                  ><b-icon icon="check" scale="2" variant="white"></b-icon
                ></template>
              </b-avatar>
            </span>
            <span @click="onAvatarClick('OL7')">
              <b-avatar badge-variant="success" variant="success">
                ...
                <template #badge v-if="isCategories.OL7"
                  ><b-icon icon="check" scale="2" variant="white"></b-icon
                ></template>
              </b-avatar>
            </span>
            <span @click="onAvatarClick('SW8')">
              <b-avatar badge-variant="success" variant="danger">
                ...
                <template #badge v-if="isCategories.SW8"
                  ><b-icon icon="check" scale="2" variant="white"></b-icon
                ></template>
              </b-avatar>
            </span>
            <span @click="onAvatarClick('BK9')">
              <b-avatar icon="bank" badge-variant="success" variant="warning">
                ...
                <template #badge v-if="isCategories.BK9"
                  ><b-icon icon="check" scale="2" variant="white"></b-icon
                ></template>
              </b-avatar>
            </span>
            <span @click="onAvatarClick('PO3')">
              <b-avatar badge-variant="success" variant="info">
                ...
                <template #badge v-if="isCategories.PO3"
                  ><b-icon icon="check" scale="2" variant="white"></b-icon
                ></template>
              </b-avatar>
            </span>
